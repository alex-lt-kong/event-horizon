...
- [x] 2. Implement calculation logic
  - [x] 2.1 Create `app/calculator.py` with pure calculation functions
  ...
  - [x]* 2.2 Write property test for calculation pipeline correctness
  ...
  - [x]* 2.3 Write unit tests for calculation functions
...
- [x] 3. Implement Pydantic models and validation
  - [x] 3.1 Create `app/models.py` with request/response Pydantic models
  ...
  - [x]* 3.3 Write property test for window validation
  ...
  - [x]* 3.4 Write property test for probability validation
  ...
  - [x]* 3.5 Write property test for structured validation errors
  ...
  - [x]* 3.6 Write property test for UTC timezone conversion
...
- [x] 5. Implement authentication module
  - [x] 5.1 Create `app/auth.py` with `TokenStore` class and `verify_token` dependency
  ...
  - [x]* 5.2 Write property test for auth token gate
  ...
  - [x]* 5.3 Write unit tests for token store
...
- [x] 6. Implement API routes and application entry point
  - [x] 6.1 Create `app/routes.py` with the POST `/api/calculate` endpoint
  ...
  - [x] 6.2 Create `app/main.py` as the application entry point
